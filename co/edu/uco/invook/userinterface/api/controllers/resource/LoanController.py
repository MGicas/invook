    ...
    def post(self, request, id: str = None):
        ...
        try:
            if action == "create":
                ...
                if not id_monitor:
                    return Response({"error": "Debe enviar 'id_monitor' en el body."}, status=status.HTTP_400_BAD_REQUEST)
                ...
                loan = self.facade.return_hardware_from_loan(id, hardware_returns, id_monitor)
