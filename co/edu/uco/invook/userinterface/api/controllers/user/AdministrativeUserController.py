...
class AdministrativeUserController(APIView):
    ...
    def get(self, request, user_id=None):
        if user_id:
            user = self.facade.get_administrative_user(user_id)
    ...
    def patch(self, request, user_id):
        user = self.facade.patch_administrative_user(user_id, **request.data)
        serializer = AdministrativeUserSerializer(user)
        return Response(serializer.data)

    def delete(self, request, user_id):
        self.facade.delete_administrative_user(user_id)
